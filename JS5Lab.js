 ...
 *
 * ↓ YOUR CODE HERE ↓ */
let myGreeting = new Greeting('James', 'USA')
myGreeting.hello()
...
let yourBook = new Book('It', 'Stephen King')
 ...
 *
 * ↓ YOUR CODE HERE ↓ */
let person1 = new Student ('Jacky', 'student')
let person2 = new Teacher ('Mr. Bean', 'teacher')
console.log(`${person1.introduction()} ${person1.details()}`)
console.log(`${person2.introduction()} ${person2.details()}`)
